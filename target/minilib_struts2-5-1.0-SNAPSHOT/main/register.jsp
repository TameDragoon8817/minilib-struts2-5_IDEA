...
<main class="form-signin">
    <form method="post" action="RegisterAction" name="frm">
        <h1 class="h3 mb-3 fw-normal">欢迎注册</h1>
        <div class="form-floating">
            <input type="text" class="form-control" id="identifynumberInput" name="identifynumber" placeholder="name@example.com">
            <label for="floatingInput">证件号码</label>
        </div>
        <div class="form-floating">
            <input type="text" class="form-control" id="nicknameInput" name="nickname" placeholder="name@example.com">
            <label for="floatingInput">姓名</label>
        </div>
        <div class="form-floating">
            <input type="text" class="form-control" id="sexInput" name="sex" placeholder="name@example.com">
